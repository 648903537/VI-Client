...
namespace com.amtec.action
{
    public class EquipmentManager
    {
        ...
        public List<EquipmentEntity> GetRequiredEquipmentData(string workorder, int processLayer)
        {
            int errorCode = 0;
            string errorMsg = "";
            ...
            string[] equipmentResultValues = new string[] { };
            errorCode = imsapi.equGetRequiredEquipmentData(sessionContext, init.configHandler.StationNumber, workorder, "-1", "-1", processLayer, "-1",
        ...
        public int UpdateEquipmentData(string workorder, int processLayer, string equipmentNo, int setupFlag)
        {
            int errorCode = 0;
            string errorMsg = "";
            string[] equipmentUploadKeys = new string[] { "EQUIPMENT_NUMBER", "ERROR_CODE" };
            string[] equipmentUploadValues = new string[] { equipmentNo, "0" };
            string[] equipmentResultValues = new string[] { };
            errorCode = imsapi.equUpdateEquipmentData(sessionContext, init.configHandler.StationNumber, setupFlag, "-1", workorder, processLayer,
            ...
            else
            {
                if (errorCode == 5)
                {
                    ...
                    else if (equipmentResultValues[1] == "1300")
                    {
                        ...
                        UpdateEquipmentData(workorder, processLayer, equipmentNo, 1);
                    }
                    else
                    {
                        errorCode = Convert.ToInt32(equipmentResultValues[1]);
        ...
        public void RemoveEquipment(string workoder, int processLayer)
        {
            int errorCode = 0;
            string errorMsg = "";
            errorCode = imsapi.equRemoveEquipment(sessionContext, init.configHandler.StationNumber, workoder, "-1", processLayer);
        ...
        public string[] GetEquipmentDetailData(string equipmentNo)
        {
            ...
            string[] equipmentGetResultKeys = new string[] { "EQUIPMENT_STATE", "ERROR_CODE", "PART_NUMBER", "PART_DESC", "EXPIRATION_DATE" };
