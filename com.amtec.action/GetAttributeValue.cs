...
namespace com.amtec.action
{
    public class GetAttributeValue
    {
        ...
        public string GetAttributeValues(string serialNumber)
        {
            ...
            string[] attributeCodeArray = new string[] { "TrayNo" };
            string[] attributeResultKeys = new string[] { "ATTRIBUTE_CODE", "ATTRIBUTE_VALUE", "ERROR_CODE" };
            string[] attributeResultValues = new string[] { };
        ...
        public string[] GetObjectValeForSN(string attriCode, string attriValue)//attriCode =*
        {
            string errorMsg = "";
            ...
            LogHelper.Info("begin api attribGetObjectsForAttributeValues (station number =" + init.configHandler.StationNumber + ",attribute code = " + attriCode + ",attribute value = " + attriValue + ")");
            int error = imsapi.attribGetObjectsForAttributeValues(sessionContext, init.configHandler.StationNumber, 0, attriCode, attriValue, 0, attributeFilters, objectResultKeys, out objectResultValues);
        ...
        public string[] GetAttributeValueForEquipment(string attributeCode, string equipmentNo)
        {
            string[] attributeCodeArray = new string[] { attributeCode };
            string[] attributeResultKeys = new string[] { "ATTRIBUTE_CODE", "ATTRIBUTE_VALUE", "ERROR_CODE" };
            string[] attributeResultValues = new string[] { };
            int error = imsapi.attribGetAttributeValues(sessionContext, init.configHandler.StationNumber, 15, equipmentNo, "0", attributeCodeArray, 0, attributeResultKeys, out attributeResultValues);
