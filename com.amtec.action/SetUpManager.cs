...
namespace com.amtec.action
{
    public class SetUpManager
    {
        ...
        public int SetupStateChange(string workorder, int processlayer, int activateFlag)
        {
            int error = 0;
            //0 = Activate setup
            //1 = Deactivate setup
            ...
            if (error != 0)
            {
                view.errorHandler(2, init.lang.ERROR_API_CALL_ERROR + " setupStateChange " + error + "(" + errorMsg + ")", "");
            }
            else
            {
