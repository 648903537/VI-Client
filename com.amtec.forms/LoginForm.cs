...
namespace com.amtec.forms
{
    public partial class LoginForm : Form
    {
        ...
        public IMSApiSessionContextStruct sessionContext1 = null;
                ...
                if (logintype == 0)
                {
                    ...
                    this.Invoke(new MethodInvoker(delegate
                    {
                        ...
                        if (config.LogInType == "COM" && serialPort.IsOpen)
                            serialPort.Close();
                        imsapi.regLogin(sessionValidationStruct, out sessionContext1);
                        MainView view = new MainView(this.txtUserName.Text.Trim(), DateTime.Now, sessionContext, sessionContext1);
                        view.ShowDialog();
                    }));
                }
                else
        ...
        {
            config = new ApplicationConfiguration(sessionContext, form);
